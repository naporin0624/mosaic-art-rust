...
export default defineConfig({
  ...
  themeConfig: {
      ...
      '/architecture/': [
        {
          ...
          items: [
            ...
            { text: 'Color Spaces', link: '/architecture/color-spaces' }
          ]
        }
      ],
    ...
    // Social links
    socialLinks: [
      { icon: 'github', link: 'https://github.com/naporin0624/mosaic-art-rust' }
    ],
  ...
  head: [
    ...
    ['meta', { property: 'og:description', content: 'High-performance mosaic art generator written in Rust' }],
    ['meta', { property: 'og:type', content: 'website' }],
    ['meta', { property: 'og:url', content: 'https://naporin0624.github.io/mosaic-art-rust/' }],
    ['meta', { property: 'og:image', content: 'https://naporin0624.github.io/mosaic-art-rust/og-image.png' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:title', content: 'Mosaic Art Generator' }],
    ['meta', { name: 'twitter:description', content: 'High-performance mosaic art generator written in Rust' }],
    ['meta', { name: 'twitter:image', content: 'https://naporin0624.github.io/mosaic-art-rust/og-image.png' }]
  ],
